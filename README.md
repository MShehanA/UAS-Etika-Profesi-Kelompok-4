...
# Skandal Algoritma Rekrutmen Amazon (2014–2018)
...
| **Nomor Kelompok** | 4 |
| **Kasus yang Dianalisis** | Algoritma Rekrutmen Amazon (2014–2018) |
...
| No | Nama | NPM | Peran / Segmen |
|----|------|------------|----------------|
| 1 | Muhammad Shehan Algi | 4524210069 | Ketua Kelompok, Bagian 10 & 11 |
| 2 | Nadine Agietha Bethesda | 4524210073 | Bagian 3 & 4 |
| 3 | Firyal Nibras Hariyadi | 4524210108 | Bagian 1 & 2 |
| 4 | Joanne Trixie Isaura | 4524210109 | Bagian 8 & 9 |
| 5 | Rihhadatul'Aisy Septifani Zain | 4524210126 | Bagian 5, 6 & 7 |
...
|-----------|-----------|----------------|
| **Sub-CPMK 1** | Analisis dilema etika menggunakan teori filsafat moral dan kode etik | Bagian 1, 4, 5, dan 6 |
| **Sub-CPMK 2** | Evaluasi kepatuhan terhadap regulasi hukum dan standar industri | Bagian 6 dan 7 |
| **Sub-CPMK 3** | Analisis dampak sosial dan lingkungan | Bagian 2, 3, dan 10 |
| **Sub-CPMK 4** | Evaluasi risiko etis menggunakan kerangka ISO 31000 | Bagian 9 |
| **Sub-CPMK 5** | Analisis integritas dan penyalahgunaan kewenangan | Bagian 8 |
| **Sub-CPMK 7** | Perumusan strategi mitigasi dan kontrol preventif | Bagian 9 dan 10 |
| **Sub-CPMK 8** | Demonstrasi hasil investigasi dalam forum profesional | Bagian 11 |
| **Sub-CPMK 9** | Refleksi prinsip etika ke dalam rencana integritas karier | Bagian 11 |
...
<p align="center">
  <a href="https://youtu.be/Cy353-aX3aE?si=S8BJL0MtRX3l6gwk">
    <img src="https://img.youtube.com/vi/Cy353-aX3aE/maxresdefault.jpg" width="500">
  </a>
</p>
...
<p align="justify"> &nbsp;&nbsp;&nbsp;&nbsp;Kasus ini terjadi pada tahun 2014, Amazon mulai mengembangkan sistem rekrutmen yang berbasis Artificial Intelligence untuk membantu proses seleksi kandidat. Tujuan utama sistem ini adalah meningkatkan efisiensi perekrutan dengan mengurangi waktu yang dibutuhkan untuk memilih kandidat yang tepat. Sistem AI tersebut dididik dengan menggunakan data historis perekrutan selama sepuluh tahun. Sayangnya, sebagian besar data yang digunakan berasal dari pelamar laki-laki, karena industri teknologi pada saat itu masih didominasi oleh pekerja laki-laki.</p>
<p align="justify"> &nbsp;&nbsp;&nbsp;&nbsp;Dengan demikian, sistem AI itu sendiri mengalami bias. Ia mempelajari bahwa karakteristik kandidat laki-laki adalah indikator kandidat yang paling "ideal". Akibatnya, sistem tersebut secara otomatis memberikan nilai yang lebih rendah pada CV yang mengandung kata "women's" atau berasal dari institusi pendidikan khusus perempuan. Meskipun Amazon akhirnya memutuskan untuk menghentikan penggunaan sistem tersebut setelah menemukan adanya bias, kasus ini tetap menjadi contoh penting tentang risiko penggunaan AI dalam pengambilan keputusan yang berdampak pada kehidupan manusia. 
</p>

<br>
<b>Bagian 2 - Fakta Kunci & Catatan Transparansi </b>
<p align="justify"> &nbsp;&nbsp;&nbsp;&nbsp;Kasus Amazon menunjukkan bagaimana penggunaan AI dalam proses rekrutmen dapat berakhir buruk. Sistem AI yang dikembangkan untuk membantu perusahaan menyaring kandidat secara otomatis ternyata memiliki kelemahan signifikan. Data pelatihan yang digunakan berasal dari riwayat perekrutan perusahaan yang dominan oleh laki-laki, sehingga sistem AI banyak belajar tentang preferensi yang dominan pada laki-laki. Akibatnya, sistem AI justru menurunkan penilaian terhadap lulusan institusi pendidikan perempuan, meskipun kompetensinya setara dengan lulusan pria. Selain itu, sistem menggunakan model yang sangat kompleks sehingga proses pengambilan keputusan sulit dipahami, baik oleh pengguna maupun pengembang. Kandidat tidak mengetahui alasan mereka diterima atau ditolak, sehingga perusahaan sendiri juga mengalami kesulitan mendeteksi bias sejak awal. Hal ini disebabkan karena tidak dilakukan audit algoritma secara menyeluruh, sehingga rendahnya transparansi dalam sistem menyebabkan akuntabilitas menjadi lemah. Tidak ada pihak yang secara jelas dapat mempertanggungjawabkan keputusan yang dihasilkan AI.</p>
...
<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;Di sisi lain, kasus ini menyampaikan pelajaran berharga tentang tanggung jawab semua pemangku kepentingan dalam pengembangan teknologi AI. Tim pengembang bertanggung jawab untuk menciptakan algoritma yang tidak bias, sementara divisi Sumber Daya Manusia tidak seharusnya sepenuhnya mengandalkan hasil AI tanpa melakukan penilaian tambahan. Pemerintah juga berfungsi penting dalam merumuskan regulasi yang mengatur transparansi, akuntabilitas, dan etika penggunaan AI supaya teknologi tidak menyebabkan diskriminasi atau pelanggaran hak asasi manusia.</p>
<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;Di samping itu, tingkat kepercayaan masyarakat terhadap teknologi AI sangat ditentukan oleh cara penggunaan teknologi itu. Jika perusahaan dapat mengimplementasikan pengelolaan AI yang efektif, memanfaatkan data pelatihan yang mencerminkan, serta melakukan penilaian algoritma secara rutin, maka AI bisa menjadi sarana yang mendukung proses rekrutmen dengan cara yang lebih objektif dan efisien. Sebaliknya, jika bias dibiarkan, masyarakat akan semakin mempertanyakan pemanfaatan AI dalam proses pengambilan keputusan yang berpengaruh pada kehidupan manusia.</p>
<br>
...
<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;Keandalan sistem AI sangat ditentukan oleh mutu data yang diterapkan dalam pelatihan. Jika data pelatihan sengaja dipilih atau dibiarkan tetap mengandung bias sehingga menguntungkan kelompok tertentu, maka keputusan yang dihasilkan oleh AI menjadi tidak adil. Dengan demikian, perusahaan harus melakukan audit data pelatihan secara rutin agar sistem berfungsi dengan adil.</p>
<b>4. Konflik Kepentingan dalam Pengembangan AI </b>
<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;Pengembang dan pengambil keputusan perlu menjauhi konflik kepentingan yang dapat mempengaruhi objektivitas sistem AI. Contohnya, jika algoritma dibuat untuk lebih mengunggulkan kandidat dari kelompok tertentu demi kepentingan organisasi atau perorangan, maka ini bertentangan dengan prinsip profesionalisme, integritas, serta keadilan dalam proses perekrutan.</p>
<b>5. Pengawasan Manusia (Human Oversight) </b>
<p align="justify">&nbsp;&nbsp;&nbsp;&nbsp;Keputusan terakhir dalam proses perekrutan sebaiknya tidak sepenuhnya diandalkan pada AI. Partisipasi manusia sebagai pengawas (human-in-the-loop) menjadi titik pengawasan yang krusial untuk menjamin bahwa hasil rekomendasi AI memenuhi prinsip keadilan, bebas dari diskriminasi, dan dapat dipertanggungjawabkan. Pengawasan ini juga berperan sebagai alat pengendalian untuk menghindari terjadinya kesalahan sistem serta penyalahgunaan teknologi.</p>
